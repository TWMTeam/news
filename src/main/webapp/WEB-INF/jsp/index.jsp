...
<body >
	<div id="header">
		<div id="top_login">
			<form action="util/control_admin_login.jsp" method="post"
				onsubmit="return check()">
				<label> 登录名 </label> <input type="text" id="u_name" name="u_name"
					value="" class="login_input" /> <label> 密&#160;&#160;码 </label> <input
					type="password" id="u_password" name="u_password" value=""
					class="login_input" /> <input type="submit" class="login_sub"
					value="登录" /> <label id="error"> </label> <img
